...
const fs = require('fs');
const app = express();
let credentials = key: fs.readFileSync(path.join(__dirname,'./home/ubuntu/cert/key.pem')), cert: fs.readFileSync(path.join(__dirname,'./home/ubuntu/cert/cert.pem')), rejectUnauthorized: false};
